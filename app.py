...
servidores = [
    ("¡LOL!", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Trae suerte y fomenta la amistad en juegos, tanto físicos como online."),
    ("La Águila", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Protectora contra la violencia sexual, brindando fortaleza y seguridad al evocador."),
    ("La Banquera", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Experta en manejo financiero y apuestas, aportando sabiduría y estrategias para mejorar la situación económica del evocador."),
    ("Cupido", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Encargado de unir corazones y fomentar el amor, ayudando a que las relaciones florezcan."),
    ("La Curandera", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Especialista en resolver problemas de salud, aportando energía curativa y bienestar."),
    ("La Ilusionista", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Capaz de manipular los sueños según el deseo del evocador, creando experiencias oníricas personalizadas."),
    ("La Profesora", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Facilita el aprendizaje y el camino hacia el éxito académico, promoviendo la comprensión y retención de conocimientos."),
    ("La Suerte", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Brinda energía y determinación para alcanzar metas, favoreciendo la buena fortuna en los objetivos del evocador."),
    ("La Vengadora", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Representa la venganza y la oscuridad, actuando en situaciones donde la justicia y el equilibrio deben ser restablecidos."),
    ("ABRALAS", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Facilitador de procesos y fluidez en la vida cotidiana, eliminando obstáculos y creando un camino despejado para el evocador."),
    ("Agromora", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Mejora las habilidades en masajes, proporcionando destreza y sensibilidad en las técnicas aplicadas."),
    ("Aikendú", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Representa la luz, el equilibrio y la curación, proporcionando paz y armonía al evocador."),
    ("Alexia", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Elimina la depresión y la ansiedad, generando un estado emocional positivo y equilibrado."),
    ("Allie", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Resuelve problemas amorosos y sentimentales, ayudando a restaurar la armonía en las relaciones."),
    ("Alvo", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Manipula mentes, emociones y sueños, permitiendo al evocador influir en situaciones a través de la mente subconsciente."),
    ("Andaluz", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Cura aspectos psicológicos, físicos o emocionales, proporcionando equilibrio integral."),
    ("Anya", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Experta en música y notas melódicas, inspirando creatividad y sensibilidad artística."),
    ("Applause", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Ayuda a artistas a prosperar en sus proyectos, atrayendo el reconocimiento y el éxito."),
    ("Aracne", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Elimina obstáculos en la vida del evocador, tejiendo caminos más fluidos hacia sus objetivos."),
    ("Aristeia", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Promueve la eficiencia y la perfección, impulsando al evocador hacia la excelencia en sus acciones."),
    ("Aros", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Aumenta la atracción y el deseo físico, reforzando los vínculos pasionales."),
    ("Artpop", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Atrae visibilidad y admiradores, promoviendo la popularidad y el reconocimiento del evocador."),
    ("Arukah", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Deidad madre de la curación, proporcionando alivio y sanación a todos los niveles."),
    ("Aruspécia", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Auxilia en tiradas oraculares y estudios de adivinación, proporcionando claridad y guía."),
    ("Astron", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Protege a los animales y los guía de regreso a casa, actuando como un guardián espiritual para los seres del reino animal."),
    ("Aurore", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Combate traumas, miedos y fobias, generando tranquilidad y fortaleza mental."),
    ("Avóh", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Transforma la tristeza en alegría y promueve el cambio positivo, facilitando la evolución emocional."),
    ("Billy, El Creador", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Estimula la creatividad y la inspiración, brindando nuevas ideas y enfoques artísticos."),
    ("Bonita", "Servidor mágico de la magia del caos, en proceso de convertirse en un egregore. Mejora la apariencia facial y capilar, realzando la belleza exterior del evocador."),
    ...
    (
        "Revol", 
        "Este servidor revela dones espirituales y potencia rituales, facilitando la conexión con el mundo espiritual. Su camino hacia el egregore lo hará más fuerte y más eficiente en la realización de rituales."
    ),
    (
        "Rob Fire", 
        "Anfitrión nocturno que garantiza diversión y seguridad. En su transición a egregore, se volverá más efectivo en crear un ambiente de celebración y protección durante las interacciones sociales."
    ),
    (
        "Ronda", 
        "Servidor que busca oportunidades financieras y dinero cercano. Al convertirse en egregore, su capacidad para atraer riqueza y oportunidades económicas se amplificará enormemente."
    ),
    (
        "Salekah", 
        "Facilita la compra, venta o alquiler de propiedades. Su desarrollo como egregore le permitirá establecer conexiones más sólidas en el ámbito inmobiliario."
    ),
    (
        "Sallyu", 
        "Aleja amistades o parejas no aprobadas. En su transición a egregore, se fortalecerá en su capacidad de proteger al evocador de influencias indeseadas en su círculo social."
    ),
    (
        "Salvamariel", 
        "Defiende al magista y neutraliza influencias externas. Este servidor, al convertirse en egregore, potenciará su habilidad para crear un escudo energético más robusto."
    ),
    (
        "Samuy", 
        "Calma los ánimos y congela relaciones conflictivas. Su evolución a egregore le permitirá manejar mejor las tensiones y conflictos, ofreciendo un espacio de paz al evocador."
    ),
    (
        "Saturnino", 
        "Brinda energía de Saturno en cualquier momento. Su desarrollo como egregore le permitirá ofrecer estabilidad y sabiduría en situaciones de cambio."
    ),
    (
        "Self", 
        "Aumenta la autoestima y el autoconocimiento. En su proceso de convertirse en egregore, se volverá más poderoso al apoyar la evolución personal del evocador."
    ),
    (
        "Sereia", 
        "Este servidor atrapa con su canto magnético y atractivo. A medida que se convierte en egregore, su habilidad para atraer relaciones y oportunidades románticas se intensifica."
    ),
    (
        "Shastra Ganika", 
        "Empodera en arte, ciencia y sexualidad. Su transición a egregore potenciará su influencia en el ámbito creativo y científico, ayudando a liberar el potencial del evocador."
    ),
    (
        "Solicio", 
        "Brinda energía del Sol en cualquier momento. Al convertirse en egregore, su luz será aún más brillante, facilitando la manifestación de deseos y objetivos."
    ),
    (
        "Soliloki", 
        "Subcontrata otros Servos Astrales para realizar pedidos. Su evolución hacia egregore le permitirá gestionar mejor las interacciones entre múltiples entidades espirituales."
    ),
    (
        "Sophia", 
        "Equilibra y abre el Ajna para clarividencia. En su camino hacia convertirse en egregore, su conexión con la intuición y la sabiduría se profundizará."
    ),
    (
        "Sr. Fortuna", 
        "Servidor mágico que promueve la prosperidad financiera. Su transición a egregore le permitirá acumular y canalizar energía de abundancia en la vida del evocador."
    ),
    (
        "Star Ajuda", 
        "Ayuda en diversas áreas para mujeres, incluyendo salud, prosperidad y equilibrio emocional. Al convertirse en egregore, su influencia será más poderosa y abarcadora."
    ),
    (
        "STAR MEE!", 
        "Ideal para conquistar fama y popularidad, con conocimientos avanzados en marketing, imagen y psicología. En su camino hacia el egregore, su capacidad para crear visibilidad y reconocimiento crecerá."
    ),
    (
        "Starlight", 
        "Ayuda a alcanzar éxito y prosperidad en cualquier situación. Su evolución a egregore fortalecerá su habilidad para abrir caminos hacia el éxito en múltiples áreas."
    ),
    (
        "Tecelão", 
        "Multiplica el dinero gastado. El TECELÓN DEL DINERO está en proceso de convertirse en un egregore, lo que potenciará su habilidad de atraer y multiplicar la riqueza."
    ),
    (
        "TecnoMago", 
        "Facilita el uso y la creación de herramientas tecnomágicas. Su desarrollo hacia egregore le permitirá gestionar mejor las tecnologías y su aplicación mágica."
    ),
    (
        "Terra", 
        "Se encarga de todo lo relacionado al cultivo y cuidado de plantas. En su camino hacia convertirse en egregore, su conexión con la naturaleza se amplificará."
    ),
    (
        "Tévyah", 
        "Enfocado en ganancias financieras, incluyendo juegos de lotería. Su transición a egregore le permitirá optimizar y amplificar las oportunidades de éxito financiero."
    ),
    (
        "The Abundance", 
        "Servidor astral para prosperidad financiera en diversas áreas. A medida que se desarrolla como egregore, su capacidad para atraer riqueza y abundancia se intensificará."
    ),
    (
        "The Adventurer - A Aventureira", 
        "Fomenta la exploración y nuevas experiencias. En su camino hacia convertirse en egregore, su energía permitirá al evocador abrirse a nuevas aventuras y oportunidades."
    ),
    (
        "The Alice", 
        "Despierta la sed de conocimiento constante. Su transición a egregore fortalecerá su capacidad de ofrecer acceso a la sabiduría y el aprendizaje."
    ),
    (
        "The Alpha", 
        "Concede características de liderazgo y seducción. A medida que se convierte en egregore, su influencia sobre la autoconfianza y el carisma se amplificará."
    ),
    (
        "The Balancer - A Balanceadora", 
        "Promueve mantener una vida equilibrada y armoniosa. Su desarrollo como egregore le permitirá potenciar la estabilidad y la paz interior."
    ),
